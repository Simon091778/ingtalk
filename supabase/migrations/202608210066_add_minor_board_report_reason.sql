-- Treat suspected minors in the anonymous board as an urgent safety report.
...
begin
  ...
  if reason_code not in ('inappropriate', 'spam', 'harassment', 'fraud', 'sexual', 'suspected_minor', 'other') then
  ...
  insert into public.reports(
    ...
    case
      when reason_code = 'suspected_minor' then 'urgent'
      when reason_code = 'sexual' then 'high'
      else 'normal'
    end
