-- Treat the new open-chat notification choice like every other customized
-- notification preference when deciding whether a phone-only bootstrap account
-- is safe to retire automatically.
...
begin
  ...
  if exists(select 1 from public.notification_preferences n where n.user_id=aid and
      not (n.message_enabled and n.open_chat_enabled and n.request_enabled and n.preview_enabled and n.sound_enabled and n.vibration_enabled)) then
