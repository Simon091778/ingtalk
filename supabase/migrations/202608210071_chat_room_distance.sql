-- Show the same privacy-preserving rounded distance used by discovery and request lists.
...
language sql stable security definer set search_path = public, extensions as $$
  ...
  left join public.user_locations other_location on other_location.user_id = other_member.user_id
