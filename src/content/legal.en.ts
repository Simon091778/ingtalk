export const TERMS_OF_SERVICE_TEXT_EN = `Effective date: August 23, 2026
...
4. Points
Points are used only for service features and cannot be exchanged for cash or property. Rewards are limited to the stated frequency. Points obtained through abuse, errors, or violations may be revoked. Paid-point purchase and refund terms are disclosed separately.
