...
결제를 선택하면 RevenueCat과 Apple App Store 또는 Google Play가 내부 앱 계정 ID, 상품·거래·영수증 식별자, 구매 시각·금액·통화·국가 및 환불 정보를 처리합니다. 잉톡은 카드번호나 은행 계좌번호를 직접 수집하지 않습니다. 이 정보는 구매 검증, 포인트 지급, 중복 지급 방지 및 환불 처리에 사용합니다.
